<template>
  <div class="grid fluid dashboard">
    ...
    <div class="col-12 md:col-6 lg:col-4 contact-form">
      <Panel header="Contact Us">
        <div class="grid">
          ...
          <div class="col-12">
            <InputText type="text" placeholder="Name" class="w-full" />
          </div>
          <div class="col-12">
            <InputText type="text" placeholder="Age" class="w-full" />
          </div>
          <div class="col-12">
            <InputText type="text" placeholder="Message" class="w-full" />
          </div>
          <div class="col-12">
            <Button type="button" label="Send" icon="pi pi-envelope" class="w-full" />
          </div>
        </div>
      </Panel>
    </div>
